"use strict";
function Numpercentage(obt:number, total:number) {
...
//   } 
  ...
  function calculateTax(units:number)
   {
...
function checkPassFail(attendance:number, practicalMarks:number, theoryMarks:number)
 {
